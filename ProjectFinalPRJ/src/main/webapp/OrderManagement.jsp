<%-- 
    ...
    Created on : Nov 7, 2022, 8:26:17 PM
    Author     : QuangQui
--%>
                    ...
                    <table class="table table-striped">
                        <thead>
                            <tr>
                                ...
                                <th style="width: 30% ">DeliveryAddress</th>
                                <th style="width: 15% ">TotalBill</th>
                                <th>Action</th>
                            </tr>
                        </thead>
                        <%
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <a href="/Order/Info/<%= rs.getString("OrderID")%>" class="view" title="View" data-toggle="tooltip"><i class="fa fa-eye"></i></a>
