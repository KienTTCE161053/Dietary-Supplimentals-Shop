<%-- 
    Document   : OrderElement
    Created on : Nov 7, 2022, 8:26:36 PM
    Author     : QuangQui
--%>

<%@page import="java.sql.ResultSet"%>
<%@page import="com.daos.OrderElementDAO"%>
<%@page contentType="text/html" pageEncoding="UTF-8"%>
<!DOCTYPE html>
<html>
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <title>All Element Of Order</title>
    ...
    <body>
        <%
            ...
            OrderElementDAO dao = new OrderElementDAO();
...
<!--                                <div class="search-box">
                    ...
                    <table class="table table-striped">
                        <thead>
                            <tr>
                                <th style="width: 30%">ProductID</th>
                                <th style="width: 30%">Quantity</th>                           
                                <th style="width: 30%">TotalPrice</th>
